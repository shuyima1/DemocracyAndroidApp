...
def create_question(question_text,days):
	"""
	Creates a question with the given 'question text' and published the given number of 'days' offset to now (negative for questions published in the past, positive for questions that have yet to be published)
	"""
...
class QuestionViewTests(TestCase):
	...
	def test_index_view_with_a_fututre_question(self):
		"""
	...
	def test_index_view_with_two_past_questions(self):
		"""
		The questions index should display multiple questions from the past
